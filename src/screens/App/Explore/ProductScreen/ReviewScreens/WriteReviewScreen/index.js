...
import ProductScreenWriteReviewScreenHeader from "./header";
...
const ProductScreenWriteReviewScreen = ({
    route,
}) => {
    const {productId} = route?.params;
    const {products, addReview, checkExistingReview} = useData();
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Record positive action for review submission
            recordPositiveAction('review_submitted');
    ...
    return (
        ...
        >
            ...
            >
                <ProductScreenWriteReviewScreenHeader
                ...
                >
                    <DefaultButton
                        ...
                        isActive={!isSubmitting && rating !== null}
...
export default ProductScreenWriteReviewScreen;
